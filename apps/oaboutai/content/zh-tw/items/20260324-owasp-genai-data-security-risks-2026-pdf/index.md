...
detailed_notes: 文件將資料層視為 GenAI 安全主戰場，涵蓋敏感資料洩漏、憑證暴露、Shadow AI、投毒、向量庫安全、跨上下文污染、遙測洩漏與模型外流等場景。落地重點包括
  AI-DSPM、最小權限、資料分級治理與持續監測。Google Drive 連結：https://drive.google.com/file/d/1WXuaPq9S_WuXnJzfRd0zY729KbMYuLCv/view?usp=drivesdk
keywords:
- risk-management
